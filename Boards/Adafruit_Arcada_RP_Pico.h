...
/*
#define PIN_QSPI_SCK 52
#define PIN_QSPI_CS 56
#define PIN_QSPI_IO0 53
#define PIN_QSPI_IO1 55
#define PIN_QSPI_IO2 54
#define PIN_QSPI_IO3 51
*/
...
public:
  ...
  void displayBegin(void) {
	bool r = SPI.setRX(16);
	bool c = SPI.setCS(17);
    bool s = SPI.setSCK(18);
    bool t = SPI.setTX(19);
	Serial.printf("SPI %d %d %d %d\n", r, c, s, t);
	
	Adafruit_ST7789 *tft = new Adafruit_ST7789(&ARCADA_TFT_SPI, ARCADA_TFT_CS, ARCADA_TFT_DC, -1);
    tft->init(240, 240);
